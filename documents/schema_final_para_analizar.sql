...
-- DROP SCHEMA IF EXISTS squema_v1 ;

CREATE SCHEMA IF NOT EXISTS squema_v1
...
/* 1. Cadastrando a tabela cliente (3 cadastros) */ 
...
/* 2. Cadastrando a tabela mecanico (3 cadastros) */
...
/* 3. Cadastrando a tabela servico (3 cadastros) */
...
/* 4. Cadastrando a tabela peca (3 cadastros) */
...
/* 5. Cadastrando a tabela veiculo (3 cadastros) */ 
...
-- 6. Cadastrando a tabela agendamento (3 cadastros)
...
-- 7. Cadastrando a tabela ordem_de_servico (3 cadastros)
...
-- 8. Cadastrando a tabela item_ordem_servico (3 cadastros)
...
-- 9. Cadastrando a tabela peca_ordem_servico (3 cadastros)
